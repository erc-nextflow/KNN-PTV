...
OutDirK =  strcat([OutDir 'Minidataset\\' OutName ]);                       % output directory name
NImgMini=1:200;                                                             % vector of snapshots for testing 
...
RK = 1:5:bref; RK(end) = bref;                                             % Range of K for Kopt, you can choose manually and decide how much refine (you can modify only the step). Finest vector implies high computational costs, that you can avoid thanks the cubic interpolation.
